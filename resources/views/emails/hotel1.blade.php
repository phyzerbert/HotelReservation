								...
								<div class="col num12" data-body-width-son="625" rel="col-num-container-box-son" style="min-width: 320px; max-width: 625px; display: table-cell; vertical-align: top;">
									<div style="width:100% !important;">
										<div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
											...
											<div style="color:#FFFFFF;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%;padding-top:20px;padding-right:20px;padding-bottom:20px;padding-left:20px;">
												<div style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 14px; color: #FFFFFF;">
													<div style="line-height: 14px; font-size: 12px; text-align: center;">
														<span style="font-size: 26px; line-height: 31px;">Your Reservation</span>
													</div>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											...
											<div style="color:#FFFFFF;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:180%;padding-top:0px;padding-right:20px;padding-bottom:25px;padding-left:20px;">
												<p style="font-size: 12px; line-height: 28px; color: #FFFFFF; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0;">
													<span style="font-size: 16px;">A visitor want to stay in your hotel.</span>
												</p>
												<p style="font-size: 12px; line-height: 28px; color: #FFFFFF; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0;">
													<span style="font-size: 16px;"> We are pleased to provide visitors as follows.</span>
												</p>
												<p style="font-size: 12px; line-height: 28px; color: #FFFFFF; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0;">
													<span style="font-size: 16px;"> Please reply to the request in this url. </span>
												</p>
												<p style="font-size: 10px; line-height: 28px; color: #FFFFFF; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0;">
													<span style="font-size: 16px;"> {{$url}} </span>
												</p>
												<p style="font-size: 12px; line-height: 28px; color: #FFFFFF; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0; text-align: center">
													<span style="font-size: 16px;"> <a href="{{$url}}">Click Here</a></span>
												</p>
											</div>
										</div>
									</div>
											...
											<div
												...
												<div
													...
													<ul>
														...
														<li style="font-size: 18px; line-height: 32px;"><span style="line-height: 32px; font-size: 18px;">
															Visitor Phone Number: {{$reservation->visitor_phone_number}} 
														</span></li>
														<li style="font-size: 18px; line-height: 32px;"><span style="line-height: 32px; font-size: 18px;">
												...
												<tbody>
													<tr style="vertical-align: top;" valign="top">
														<td class="divider_inner"
															...
															valign="top">
															<table align="center" border="0" cellpadding="0" cellspacing="0" class="divider_content" ="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; border-top: 0px solid transparent;"
																valign="top" width="100%">
																<tbody>
																	<tr style="vertical-align: top;" valign="top">
																		<td style="word-break: break-word; vertical-align: top; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; border-collapse: collapse;" valign="top"><span></span></td>
